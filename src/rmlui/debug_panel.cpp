...
namespace client::ui
{
    ...
    void DebugPanel::Update()
    {
        ...
        SetText( "dbg_role",
                 "Role: <span style='font-size: 3vh; color: " + (
                     isHost ? Rml::String( "#34c3eb" ) : Rml::String( "orange" ) ) + "'>" + ( isHost
                         ? Rml::String( "HOST" )
                         : Rml::String( "CLIENT" ) ) + "</span>" );
        ...
        {
            case GameStage::LOBBY: stageStr = "Lobby";
                break;
            case GameStage::ROUND_IN_PROGRESS: stageStr = "Round";
                break;
            case GameStage::ROUND_END: stageStr = "End";
                break;
            default: stageStr = "?";
                break;
        }
        ...
        SetText( "dbg_color",
                 "Color: <span style='color: " + GetCardColorToRCSS_RGB( clState.TopDiscard.Color ) + "'>" +
                 CARD_COLORS_STRINGS.at( clState.TopDiscard.Color ) + "</span>" );
        ...
        SetText( "dbg_my_turn",
                 myTurn
                     ? "My Turn: <span style='color: green'>YES</span>"
                     : "My Turn: <span style='color: red'>NO</span>" );
