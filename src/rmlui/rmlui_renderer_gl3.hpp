...
namespace client::ui
{
    ...
    public:
        ...
        void SetViewport( int viewport_width, int viewport_height, int viewport_offset_x = 0,
        ...
        Rml::TextureHandle
        GenerateTexture( Rml::Span<const Rml::byte> source_data, Rml::Vector2i source_dimensions ) override;
